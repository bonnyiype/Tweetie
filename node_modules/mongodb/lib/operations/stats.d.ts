 ...
 * @internal
 */
export declare class CollStatsOperation extends CommandOperation<Document> {
    ...
    execute(server: Server, session: ClientSession | undefined, callback: Callback<CollStats>): void;
}
/** @public */
