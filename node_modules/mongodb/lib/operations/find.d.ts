...
/** @internal */
export declare class FindOperation extends CommandOperation<Document> {
    options: FindOptions;
    filter: Document;
    constructor(collection: Collection | undefined, ns: MongoDBNamespace, filter?: Document, options?: FindOptions);
